        ...
        <div className="flex p-[24px] w-full max-w-[872px] flex-col itmes-end gap-[24px] flex-1 rounded-[10px] border border-[rgba(58,53,65,0.12)] bg-[#FFF]">
            <div className="flex items-center gap-[16px] self-stretch">
                ...
                <div className="flex flex-col items-start gap-[8px]">
                    <h2 className="text-[#222325] text-center font-[Poppins] text-base sm:text-xl font-semibold leading-[120%]">Jennie Ruby Jane</h2>
                    <h3 className="text-[#222325] text-center font-[DM_Sans] text-base sm:text-lg font-normal leading-[140%] tracking-[0.02px]">rubyjane@gmail.com</h3>
