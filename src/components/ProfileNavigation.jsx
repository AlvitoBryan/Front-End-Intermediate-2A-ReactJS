const ProfileNavigation = () => {
    return(
        <div className="flex flex-col items-start gap-[24px]">
            ...
            <div className="flex w-[292px] p-[24px] flex-col items-start gap-[8px] rounded-[10px] border border-[rgba(58,53,65,0.12)] bg-[#FFF]">
                <div className="flex p-[12px] items-start gap-[12px] self-stretch rounded-[10px] border border-[#FFBD3A] bg-[rgba(255,247,215,0.80)]">
                ...
                <div className="flex p-[12px] items-start gap-[12px] self-stretch rounded-[10px]">
